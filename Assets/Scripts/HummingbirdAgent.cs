...
public class HummingbirdAgent : Agent
{
    ...
    //Allows for smoother puch changes
    ...
    //Wheather the agent is frozen (intentionally not flying)
    ...
    public override void OnEpisodeBegin(){
        ...
        //Racalculate the nearest flower now that the agent has moved
        UpdateNearestFlower();
    }
    ...
    public override void OnActionReceived(ActionBuffers vectorAction){
        ...
        // Calcultate smooth rotation changes
    ...
    /// <see cref="OnActionReceived(in ActionBuffers)"/> instead of using the neural network
    ///</summary>
    ...
    public void MoveToSafeRandomPosition(bool inFrontOfFlower){
        ...
        while(!safePositionFound && attemptsRemaining > 0){
            ...
            if (inFrontOfFlower){
                ...
                //Choose and set random starting putch an yaw
    ...
    private void UpdateNearestFlower(){
        foreach (Flower flower in flowerArea.Flowers)
        {
            if(nearestFlower == null && flower.HasNectar){
                ...
                //If current neareast flower is empty OR this flower is closer, update the nearest flower
