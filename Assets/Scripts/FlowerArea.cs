...
{
    //The diameter of the area where the agent and flowers can be used for
    ...
    public void ResetFlowers(){
        //Rotate each flower plant around the Y axis and subtly aroud X and Z
        ...
        for (int i=0; i < parent.childCount; i++){
            ...
            if (child.CompareTag("flower_plant")){
                ...
                if (flower != null){
                    ...
                    //Flower component not found, sop check children
                    FindChildFlowers(child);
                }
            }
        }
